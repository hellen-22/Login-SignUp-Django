...
urlpatterns = [
    ...
    path('password-reset/',auth_views.PasswordResetView.as_view(template_name='password/password_reset_form.html', subject_template_name='password/password_reset_subject', email_template_name='password/password_reset_email.html'), name='password_reset'),
